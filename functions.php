<?php
/**
 * Aetherfield functions and definitions
 *
 ...
 */
function aetherfield_setup() {
	/*
		* Make theme available for translation.
		* Translations can be filed in the /languages/ directory.
		* If you're building a theme based on Aetherfield, use a find and replace
		* to change 'aetherfield' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'aetherfield', get_template_directory() . '/languages' );
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'aetherfield_custom_background_args',
			array(
...
add_action( 'after_setup_theme', 'aetherfield_setup' );
 ...
 */
function aetherfield_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'aetherfield_content_width', 640 );
}
